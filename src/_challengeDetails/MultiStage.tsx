...
const MultiStageChallenge = () => {
  ...
  const stages = [
    {
      ...
      description:
        "Start your eco journey by planting trees in your local area",
      points: 100,
      status: "completed",
    ...
    },
    {
      id: 2,
      title: "Clean 5 Parks",
      description: "Organize or participate in park cleanup activities",
      points: 150,
      status: "active",
    ...
    },
    {
      ...
      description: "Collect and properly sort 50kg of recyclable materials",
      points: 200,
      status: "locked",
  ...
  const messages = [
    {
      ...
      message: "Welcome to Multi-Stage EcoWarriors Challenge!",
      time: "2h ago",
    },
    {
      sender: "Team Leader",
      message: "Stage 1 completed! Moving to stage 2 🎉",
      time: "4h ago",
    },
    {
      sender: "Jennifer",
      message: "Just finished planting my trees! 🌱",
      time: "6h ago",
    },
  ];
  ...
  // for the dynamic change of "Play Challenge" button
  ...
  // endl ----------for the dynamic change of "Play Challenge" button
  ...
  return (
    <div className="mobile-container">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-white font-semibold text-lg">
                  EcoWarriors Multi-Stage
                </h1>
                <p className="text-white/80 text-sm">
                  by EcoWarriors Foundation
                </p>
              </div>
            </div>
      ...
      {/* Challenge Roadmap */}
      <div className="mobile-padding py-6 bg-white from-muted/50 to-background">
        <div className="text-center mb-6">
          <h2 className="text-xl font-semibold text-primary mb-2">
            Challenge Roadmap
          </h2>
          <p className="text-sm text-muted-foreground">
            Complete stages to unlock the next challenge
          </p>
        </div>
        ...
        <div className="relative px-4">
          ...
          <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-primary via-primary to-muted/50"></div>
          ...
          <div className="space-y-6">
            {stages.map((stage, index) => (
              <div key={stage.id} className="relative">
                {/* Stage Card */}
                <div
                  className={`relative ml-8 p-4 rounded-lg border-2 shadow-card cursor-pointer transition-smooth ${getStageColor(
                    stage.status
                  )} ${
                ...
                >
                  {/* Stage Number/Icon */}
                  <div className="absolute -left-12 top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-full border-3 border-background bg-card flex items-center justify-center shadow-elevated z-10">
        ...
        <Card className="mt-6 p-4 mx-3 shadow-elevated border-2 border-primary">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="font-semibold text-primary">
                Stage {selectedStage} Details
              </h3>
              <Button
                variant={
                  stages[selectedStage - 1].status === "active"
                    ? "default"
                    : "secondary"
                }
                size="sm"
                disabled={stages[selectedStage - 1].status === "locked"}
              >
                {stages[selectedStage - 1].status === "completed"
                  ? "View Results"
                  : stages[selectedStage - 1].status === "active"
                  ? "Start Stage"
                  : "Locked"}
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border">
              ...
              <span className="text-sm font-semibold text-accent-foreground">
                {stages[selectedStage - 1].points} points
              </span>
            </div>
          </div>
        </Card>
                    ...
                    >
                      ...
                      {index === 0 && (
                        <div className="absolute -top-1 -right-1">
                          <div className="w-6 h-6 text-cosmic-gold rounded-full flex items-center justify-center">
...
export default MultiStageChallenge;
