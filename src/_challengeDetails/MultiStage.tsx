...
const MultiStageChallenge = () => {
  ...
  return (
    <div className="mobile-container">
      ...
      {/* Challenge Roadmap */}
      <div className="mobile-padding py-6 bg-gradient-to-b from-muted/50 to-background">
        ...
        <Card className="mt-6 p-4 shadow-elevated border-2 border-primary">
        ...
        <TabsContent value="status" className="mobile-padding space-y-4">
          ...
          <div className="flex items-center justify-center mb-4">
            <div className="bg-muted p-1 rounded-lg">
              <Button
                variant={leaderboardView === "individual" ? "default" : "ghost"}
                size="sm"
